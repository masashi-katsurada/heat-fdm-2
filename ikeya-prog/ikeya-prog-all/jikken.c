 ...
 *  
 *     ccmg heat2d-i-en.c bandlu.c call_gnuplot.c  
 */
#include <stdio.h>
#include <math.h>
#include <matrix.h>
...
int main()
{
  ...
  matrix Uk, A;
  double *B;
  double h_r, h_p, lambda_r, lambda_p, tau, t, Tmax, dt, M, M2, ex;
  double theta;
  char label[200];
...
/* A  vector_U = B を解く */
 ...
 /* 誤差を測る */
   ...
   printf("n=%d, norm=%g, t=%g, min(Uk[1][j])= %g, 誤差=%g\n",
	  n, maxnorm(N_r, N_p, Uk), t, M2, M); 
